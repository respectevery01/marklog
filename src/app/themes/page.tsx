  ...
  const themes = [
    {
      name: 'light',
      label: 'Light',
      description: 'Clean, modern, and minimal. Uses system sans-serif fonts.',
      bg: 'bg-white',
    ...
    },
    {
      name: 'dark',
      label: 'Dark',
      description: 'High contrast developer theme. Monospace fonts.',
      bg: 'bg-slate-950',
    ...
    },
    {
      name: 'ghibli',
      label: 'Ghibli',
      description: 'Warm, organic, nature-inspired. Serif fonts.',
      bg: 'bg-[#f5f0e6]',
      text: 'text-[#2d4a3e] font-serif',
      accent: 'bg-[#e8dfd0]',
      border: 'border-[#d4c9b8] rounded-lg',
      sampleCode: `theme: ghibli`,
    },
    {
      name: 'pixel',
      label: 'Pixel',
      description: 'Retro 8-bit gaming vibe. Pixelated fonts.',
      bg: 'bg-white',
      text: 'text-black font-[VT323]',
      accent: 'bg-gray-100',
